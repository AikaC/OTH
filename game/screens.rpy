        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Pós-escolhas") action Preference("after choices", "toggle")
...
screen history():
    ...
    use game_menu(_("Historico"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
